...
// vershil tussen ' en ` tussen `kan je ook variabelen in de string gebruiken, anders moet je met + werken
// met `kan je met ENTER ook newlines toevoegen. bestaat enkel in Javascript
...
//dit is ook mogelijk om html tekst te doen
